...
elseif (kind(1.0)==8) then
   ...
   call msgerror('unknown real kind for mpl_bcast interface')
end if
...
! Passed variables
real,dimension(:),intent(in) :: var !< Real array, 1d
integer,intent(in) :: root          !< Root task
...
! Passed variables
real,dimension(:,:),intent(in) :: var !< Real array, 2d
integer,intent(in) :: root            !< Root task
...
! Passed variables
integer,intent(in) :: n    !< Array size
real,intent(out) :: var(n) !< Real array, 1d
integer,intent(in) :: src  !< Source task
integer,intent(in) :: tag  !< Tag
...
! Passed variables
integer,intent(in) :: n   !< Array size
real,intent(in) :: var(n) !< Real array, 1d
integer,intent(in) :: dst !< Destination task
integer,intent(in) :: tag !< Tag
