!----------------------------------------------------------------------
! Module: module_apply_interp.f90
...
use module_namelist, only: lsqrt,nproc
use omp_lib
...
real :: beta(sdata%nc1,sdata%nl1),gamma(sdata%nc1,sdata%nl1),delta(sdata%nc1,sdata%nl0)
...
real :: beta(sdatampi%nc1b,sdatampi%nl1),gamma(sdatampi%nc1b,sdatampi%nl1),delta(sdatampi%nc1b,sdatampi%nl0)
