...
type timertype
   real :: cpu_time_start        !< CPU time start
   real :: cpu_time_end          !< CPU time end
...
private
public :: timertype,timer_start,timer_intermediate,timer_end
...
!----------------------------------------------------------------------
! Subroutine: timer_intermediate
!> Purpose: print intermediate timer
!----------------------------------------------------------------------
subroutine timer_intermediate(timer)
...
end subroutine timer_intermediate
